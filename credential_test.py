'''
Credit card safe credentials Test module
import uniittest to create uniittests for credentials
import credentials module to be tested
'''
import unittest
...
class TestCredential(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credential("Laila","kcb","kcb001")
    ...
    def test_init(self):
        ...
        '''
        self.assertEqual( self.new_credential.user_password, "Laila")
        self.assertEqual( self.new_credential.credential_name, "kcb" )
        self.assertEqual( self.new_credential.credential_password, "kcb001" )
    ...
    def test_save_multiple_credentials(self):
        ...
        test_credential = Credential("Laila2","Facebook","facebook001")
    ...
    def test_display_credential(self):
        ...
        test_credential = Credential("Laila2","kcb","kcb001")

        test_credential.save_credential()
        
        self.assertEqual( len(Credential.display_credential("Laila2")) , 2 )
